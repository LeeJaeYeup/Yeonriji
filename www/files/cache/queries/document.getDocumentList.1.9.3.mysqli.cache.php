...
${'member_srls10_argument'} = new ConditionArgument('member_srls', $args->member_srls, 'in');
${'member_srls10_argument'}->checkFilter('number');
${'member_srls10_argument'}->createConditionValue();
if(!${'member_srls10_argument'}->isValid()) return ${'member_srls10_argument'}->getErrorMessage();
} else
${'member_srls10_argument'} = NULL;if(${'member_srls10_argument'} !== null) ${'member_srls10_argument'}->setColumnType('number');
...
${'s_member_srls23_argument'} = new ConditionArgument('s_member_srls', $args->s_member_srls, 'in');
${'s_member_srls23_argument'}->createConditionValue();
if(!${'s_member_srls23_argument'}->isValid()) return ${'s_member_srls23_argument'}->getErrorMessage();
} else
${'s_member_srls23_argument'} = NULL;if(${'s_member_srls23_argument'} !== null) ${'s_member_srls23_argument'}->setColumnType('number');
...
,new ConditionWithArgument('`member_srl`',$member_srls10_argument,"in", 'and')
...
,new ConditionWithArgument('`member_srl`',$s_member_srls23_argument,"in", 'or')

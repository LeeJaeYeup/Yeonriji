...
${'rev_regdate34_argument'} = new ConditionArgument('rev_regdate', $args->rev_regdate, 'less');
${'rev_regdate34_argument'}->checkFilter('number');
${'rev_regdate34_argument'}->createConditionValue();
if(!${'rev_regdate34_argument'}->isValid()) return ${'rev_regdate34_argument'}->getErrorMessage();
} else
${'rev_regdate34_argument'} = NULL;if(${'rev_regdate34_argument'} !== null) ${'rev_regdate34_argument'}->setColumnType('date');
if(isset($args->regdate)) {
${'regdate35_argument'} = new ConditionArgument('regdate', $args->regdate, 'more');
${'regdate35_argument'}->checkFilter('number');
...
,new ConditionWithArgument('`update_order`',$rev_update_order33_argument,"more", 'and')
,new ConditionWithArgument('`regdate`',$rev_regdate34_argument,"less", 'and')
,new ConditionWithArgument('`regdate`',$regdate35_argument,"more", 'and')),'and')
));

...
${'document_srl40_argument'} = new ConditionArgument('document_srl', $args->document_srl, 'in');
...
new Table('`yeonriji_document_extra_vars`', '`extra_vars`')
));
$query->setConditions(array(
new ConditionGroup(array(
new ConditionWithoutArgument('`extra_vars`.`module_srl`','-1',"more", 'and')
,new ConditionWithArgument('`extra_vars`.`document_srl`',$document_srl40_argument,"in", 'and')

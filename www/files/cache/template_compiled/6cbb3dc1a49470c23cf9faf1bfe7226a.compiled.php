...
<!--#Meta:modules/board/skins/sketchbook5_1/css/board.css--><?php $__tmp=array('modules/board/skins/sketchbook5_1/css/board.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/sketchbook5_1/css/ie8.css--><?php $__tmp=array('modules/board/skins/sketchbook5_1/css/ie8.css','','lt IE 9','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->mi->colorset=='black'){ ?><!--#Meta:modules/board/skins/sketchbook5_1/css/black.css--><?php $__tmp=array('modules/board/skins/sketchbook5_1/css/black.css','','','');Context::loadFile($__tmp);unset($__tmp);
} ?>

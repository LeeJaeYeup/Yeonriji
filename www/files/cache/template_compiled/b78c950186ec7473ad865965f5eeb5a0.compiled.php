...
<?php } ?>
<!--#Meta:modules/board/skins/sketchbook5_2/css/print.css--><?php $__tmp=array('modules/board/skins/sketchbook5_2/css/print.css','print','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/sketchbook5_2/js/viewer.js--><?php $__tmp=array('modules/board/skins/sketchbook5_2/js/viewer.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<?php 
...
<!--#Meta:modules/board/skins/sketchbook5_2/js/jquery.mousewheel.min.js--><?php $__tmp=array('modules/board/skins/sketchbook5_2/js/jquery.mousewheel.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/sketchbook5_2/js/jquery.mCustomScrollbar.min.js--><?php $__tmp=array('modules/board/skins/sketchbook5_2/js/jquery.mCustomScrollbar.min.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/board/skins/sketchbook5_2/css/jquery.mCustomScrollbar.css--><?php $__tmp=array('modules/board/skins/sketchbook5_2/css/jquery.mCustomScrollbar.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>

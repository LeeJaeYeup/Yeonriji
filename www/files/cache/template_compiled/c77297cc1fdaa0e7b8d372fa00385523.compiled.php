...
<!--#Meta:modules/editor/skins/xpresseditor_axupload5/css/default.css--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/css/default.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<?php if($__Context->colorset == "black" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "black_text_usehtml"){ ?>
	<!--#Meta:modules/editor/skins/xpresseditor_axupload5/css/black.css--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/css/black.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<?php if($__Context->colorset == "white_texteditor" || $__Context->colorset == "black_texteditor" || $__Context->colorset == "white_text_nohtml" || $__Context->colorset == "black_text_nohtml" || $__Context->colorset == "white_text_usehtml" || $__Context->colorset == "black_text_usehtml"){ ?>
	<!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/xe_textarea.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/xe_textarea.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
	<!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/xe_textarea.min.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/xe_textarea.min.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
...
<?php }else{ ?>
	...
	<!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/Xpress_Editor.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/Xpress_Editor.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
	<!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/xe_interface.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/xe_interface.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
	<!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/xpresseditor.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/xpresseditor.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
	<!-- 자동저장용 폼 -->
	...
	<div class="xpress-editor <?php echo $__Context->editor_class ?>">
		...
		<div id="fileUploader_<?php echo $__Context->editor_sequence ?>" class="fileUploader" cond="$allow_fileupload"><!--File upload zone-->
			<?php 
				$__Context->oFileModel = &getModel('file');
				$__Context->tmp_files = $__Context->oFileModel->getFiles($__Context->upload_target_srl);
			 ?>
			<block loop="$tmp_files => $key,$file_info">
				<?php  $__Context->attached_size += $__Context->file_info->file_size  ?>
			
			<div id="uploadQueueBox" class="AXUpload5QueueBox"></div>
			<div class="fileUploadControl">
				<div class="Hspace10"></div>
				<div class="AXUpload5" id="AXUpload5"></div>
				<input type="button" value="<?php echo $__Context->lang->AXupload_cancel ?>" class="AXButton Red" id="uploadCancelBtn" disabled="disabled" onclick="myUpload.cancelUpload();" />
				<input type="button" value="<?php echo $__Context->lang->edit->delete_selected ?>" class="AXButton" onclick="myUpload.deleteSelect();" />
				<input type="button" value="<?php echo $__Context->lang->AXdelete_all ?>" class="AXButton" onclick="myUpload.deleteSelect('all');" />
				<input type="button" value="<?php echo $__Context->lang->edit->link_file ?>" class="AXButton Classic" onclick="myUpload.custom.insertUploadedFile('<?php echo $__Context->editor_sequence ?>');" />
				<input type="button" value="<?php echo $__Context->lang->AXcover ?>" class="AXButton Green" onclick="myUpload.setCover('<?php echo $__Context->editor_sequence ?>');" />
				<div class="AXlogo"><a href="http://www.axisj.com/" title="Awesome UI library AXISJ" target="_blank"></a></div>
				<div class="file_attach_info" id="uploader_status_<?php echo $__Context->editor_sequence ?>"></div>
			</div>
		</div>
	</div>
	<!-- 에디터 활성화 -->
	<script>//<![CDATA[
		...
		var editorSequence = <?php echo $__Context->editor_sequence ?>;
		<?php if($__Context->allow_fileupload){ ?>
		<?php if($__Context->editor_class == "black"){ ?>
			<!--#Meta:modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/black/AXJ.css--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/black/AXJ.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
			<!--#Meta:modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/black/AXButton.css--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/black/AXButton.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
			<!--#Meta:modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/black/AXUpload5.css--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/black/AXUpload5.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		<?php }else{ ?>
			<!--#Meta:modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/default/AXJ.css--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/default/AXJ.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
			<!--#Meta:modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/default/AXButton.css--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/default/AXButton.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
			<!--#Meta:modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/default/AXUpload5.css--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/_AXJ/ui/default/AXUpload5.css','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		<?php } ?>
		<!--#Meta:modules/editor/skins/xpresseditor_axupload5/_AXJ/lib/AXJ.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/_AXJ/lib/AXJ.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		<!--#Meta:modules/editor/skins/xpresseditor_axupload5/_AXJ/lib/AXUpload5.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/_AXJ/lib/AXUpload5.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		<!--#Meta:modules/editor/skins/xpresseditor_axupload5/js/AXUpload5forNuri.js--><?php $__tmp=array('modules/editor/skins/xpresseditor_axupload5/js/AXUpload5forNuri.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
		var editor_params = {
					...
					"uploadMaxTotalFileSize" : <?php echo $__Context->file_config->allowed_attach_size ?>,
					"uploadLeftFileSize" : <?php echo ($__Context->file_config->allowed_attach_size-$__Context->attached_size) ?>,
					"uploadMaxFileSize" : <?php echo $__Context->file_config->allowed_filesize ?>,
					"allowed_filetypes" : "<?php echo $__Context->file_config->allowed_filetypes ?>",
					"lang" : {
						"uploadButtonTitle" : "<?php echo $__Context->lang->edit->upload_file ?>",
						"uploadButtonEditor" : "<?php echo $__Context->lang->edit->link_file ?>",
						"error_fileSize" : "<?php echo $__Context->lang->AXerror_fileSize ?>",
						"error_html5Support" : "<?php echo $__Context->lang->AXerror_html5Support ?>",
						"error_fileCount" : "<?php echo $__Context->lang->AXerror_fileCount ?>",
						"msg_file_cart_is_null" : "<?php echo $__Context->lang->msg_file_cart_is_null ?>",
						"confirm_delete" : "<?php echo $__Context->lang->confirm_delete ?>",
						"error_deleteQueue" : "<?php echo $__Context->lang->AXerror_deleteQueue ?>",
						"uploadSelectTxt" : "<?php echo $__Context->lang->AXuploadSelectTxt ?>",
						"dropZoneTxt" : "<?php echo $__Context->lang->AXdropZoneTxt ?>",
						"cancelMsg" : "<?php echo $__Context->lang->AXcancelMsg ?>",
						"allowed_filetypes" : "<?php echo $__Context->lang->AXallowed_filetypes ?>",
						"uploadFileSize" : "<?php echo $__Context->lang->AXuploadFileSize ?>",
						"res_error" : "<?php echo $__Context->lang->AXres_error ?>",
						"error_coverNone" : "<?php echo $__Context->lang->AXerror_coverNone ?>",
						"error_coverSelect" : "<?php echo $__Context->lang->AXerror_coverSelect ?>",
						"error_coverImage" : "<?php echo $__Context->lang->AXerror_coverImage ?>"
					}
			};

	...
	<header class="header">
		<h1>
			<a href="<?php echo geturl('') ?>" id="siteTitle">
                    <span style="font-family:'바탕체'";><span style="font-weight: 100;padding-right: 20px;">月刊</span>連理枝 </span>
				...
				<?php if(Context::getSiteTitle() && !$__Context->layout_info->LOGO_IMG && !$__Context->layout_info->LOGO_TEXT){ ?>連理枝<?php } ?>
				...
				<?php if(!$__Context->layout_info->LOGO_IMG && $__Context->layout_info->LOGO_TEXT){ ?>連理枝<?php } ?> -->
			</a>
		</h1>
		<div class="side">
			<!-- ACCOUNT 月刊 連理枝-->

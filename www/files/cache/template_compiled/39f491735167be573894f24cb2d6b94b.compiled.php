...
if($__Context->item->mustRequired || !$__Context->item->isUse){ ?> disabled="disabled"<?php } ?> /> <?php echo $__Context->lang->cmd_optional ?></label>
							<?php if($__Context->item->imageType){ ?><div class="_subItem"<?php if(!$__Context->item->isUse){ ?> style="display:none"<?php } ?>>
								...
								<label for="<?php echo $__Context->item->name ?>_max_filesize"><?php echo $__Context->lang->allowed_filesize ?> : <input type="number" min="1" name="<?php echo $__Context->item->name ?>_max_filesize" id="<?php echo $__Context->item->name ?>_max_filesize" value="<?php echo $__Context->item->max_filesize ?>" /> KB</label>
							</div><?php } ?>
